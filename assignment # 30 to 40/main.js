//task # 30
'';
let users, any = ["Ali", "Hamza", "Haseeb", "Shagufta", "Admin"];
...
// ================================================ task3 37 =================================================
function makesshirt(size = " Large ", message = "I Love TypeScript") {
...
//==============================================================================================================
// ============================================= task # 40 =====================================================
function makeAlbum(artist_name, albumtittle, tracks) {
    let album = {
        artist: artist_name,
        tittle: albumtittle,
    };
